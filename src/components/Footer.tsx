  ...
  return (
    <footer className="relative z-10 border-t border-white/[0.04] mt-16">
      <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col items-center gap-4">
        <div className="max-md:hidden flex flex-col items-center gap-4 w-full max-w-xs" ref={adminFormRef}>
          {adminOpen ? (
            <form onSubmit={handleAdminLogin} className="w-full rounded-xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-xl p-3">
              ...
              <button
                ...
                className="mt-2 text-white/30 text-[11px] hover:text-white/50 transition-colors cursor-pointer"
              >
                Cancel
              </button>
            </form>
