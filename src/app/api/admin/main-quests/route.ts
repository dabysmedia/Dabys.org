...
export async function PUT(request: Request) {
  ...
  const validated: MainQuestDefinition[] = definitions
    ...
    .map((d: Record<string, unknown>) => ({
      ...
      rewardType: d.rewardType === "stardust" ? "stardust" : d.rewardType === "pack" ? "pack" : "credits",
      rewardPackId: d.rewardType === "pack" && typeof d.rewardPackId === "string" ? d.rewardPackId : undefined,
